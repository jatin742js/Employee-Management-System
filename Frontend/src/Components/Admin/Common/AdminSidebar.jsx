      ...
      <aside className="hidden md:flex flex-col h-full w-64 bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700">
        ...
        <div className="p-5 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 via-violet-600 to-sky-600 shadow-md">
              <Briefcase className="h-5 w-5 text-white" />
            </div>
            <div className="min-w-0">
              <span className="text-lg font-bold leading-tight text-gray-900 dark:text-white">AdminHub</span>
              <p className="mt-0 text-xs text-gray-500 dark:text-gray-400">Control panel for operations</p>
            </div>
          </div>
        </div>

        {/* Admin Profile Card */}
        <div className="p-5 mt-5 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-start space-x-3">
            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 via-violet-600 to-sky-600 shadow-md ring-4 ring-indigo-100 dark:ring-gray-700">
